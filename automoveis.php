<?php
include 'conexao.php';
$result = mysqli_query($connection, "SELECT * FROM automoveis");
$automoveiss = $result->fetch_all(MYSQLI_ASSOC);
?>
...
<html lang="ptBR">
    ...
    <body>
        ...
        <section class="--style-content">
            <div>
                <a class="--list d-flex justify-content-start">Lista de Automoveis</a>               
            </div>
            <a type="button" class=" --button-register btn btn-success" href="cadastro_automoveis.php">Cadastrar Automoveis</a>
            <table class="table ">
                <thead>
                    <tr>
                        <th class="--style-th" >#</th>
                        <th class="--style-th" >Valor (Mil)</th>
                        <th class="--style-th" >Modelo</th>
                        <th class="--style-th" >Marca</th>
                        <th class="--style-th" >Ano de fabricação</th>
                        <th class="--style-th" >Placa</th>
                        <th class="--style-th" >Cor</th>
                        <th class="--style-th" >Portas</th>
                        <th class="--style-th" >Ações</th>
                        
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($automoveiss as $automoveis) { ?>
                        <tr class="--style-tr">
                            <td><?php echo $automoveis["id"]; ?></td>
                            <td><?php echo $automoveis["valor"]; ?></td>
                            <td><?php echo $automoveis["modelo"]; ?></td>
                            <td><?php echo $automoveis["marca"]; ?></td>
                            <td><?php echo date("d/m/Y", strtotime($automoveis["fabricacao"])); ?></td>                       
                            <td><?php echo $automoveis["placa"]; ?></td>
                            <td><?php echo $automoveis["cor"]; ?></td>
                            <td><?php echo $automoveis["portas"]; ?></td>
                            <td class="--button-edit btn btn-primary">
                                <?php echo "<a href='edita_automoveis.php?id={$automoveis['id']}'>Editar</a>"; ?>
                            </td>
                            <td class="--button-delete btn btn-danger">
                                <?php echo "<a href='exclui_automoveis.php?id={$automoveis['id']}'>Excluir</a>"; ?>
                            </td>
                            <td class="--button-delete btn btn-success"> 
                                <?php echo "<a href='compra.php?id={$automoveis['id']}'>Comprar</a>"; ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
