...
if (isset($_REQUEST['btnCadastrar'])) {
    ...
    if (!$erro) {
        $sql = "INSERT INTO clientela (nome, email, celular, Cpf, data_nascimento) VALUES ('$nome','$email','$celular','$Cpf','$data_nascimento')";
        
        $result = mysqli_query($connection, $sql);

        if ($result) {
            header("Location: http://localhost/teste/clientela.php");
        } else {
...
<header>
    ...
    <form action="cadastro_clientela.php" method="post">
