<?php
include 'conexao.php';
$result = mysqli_query($connection, "SELECT * FROM vendedor");
...
<html lang="ptBR">
    ...
    <body>
        ...
        <section class="--style-content">
            <div>
                <a class="--list d-flex justify-content-start">Lista de Vendedores</a>              
            </div>
            <a type="button" class=" --button-register btn btn-success" href="cadastro_vendedor.php">Cadastrar Vendedor</a>
            <table class=" table ">
                <thead>
                <tr>
                    ...
                    <th class="--style-th">Setor de trabalho</th>
                    <th class="--style-th">Data Nascimento</th>
                ...
                <tbody >
                    <?php foreach ($vendedores as $vendedor) { ?>
                        <tr class="--style-tr">
                            ...
                            <td><?php echo $vendedor["setor_trabalho"]; ?></td>
                            <td><?php echo date("d/m/Y", strtotime($vendedor["data_nascimento"])); ?></td>
                            <td class="--button-edit btn btn-primary">
                                <?php echo "<a href='edita_vendedor.php?id={$vendedor['id']}'>Editar</a>"; ?>
                            </td>
                            <td class="--button-delete btn btn-danger">
                                <?php echo "<a href='exclui_vendedor.php?id={$vendedor['id']}'>Excluir</a>"; ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
